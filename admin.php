...
<?php if(empty($_SESSION['logged'])): ?>
  <div class="max-w-sm mx-auto bg-white p-6 rounded shadow">
    ...
    <form method="post" class="space-y-4">
      ...
      <button class="w-full bg-green-600 text-white py-2 rounded">Entrar</button>
    </form>
  </div>
<?php else: ?>
  ...
  <?php foreach($categories as $cat): ?>
    <form method="post" class="flex gap-2 mb-2">
      ...
      <button name="updateCategory" class="px-3 bg-blue-500 text-white rounded">Guardar</button>
  ...
  <form method="post" class="flex gap-2 mb-8">
    ...
    <button name="addCategory" class="px-3 bg-green-600 text-white rounded">Agregar</button>
  </form>
  ...
  <?php foreach($products as $p): ?>
    <form method="post" class="grid grid-cols-7 gap-2 mb-2 items-center">
      ...
      <button name="updateProduct" class="px-3 bg-blue-500 text-white rounded">Guardar</button>
      <button name="deleteProduct" class="px-3 bg-red-500 text-white rounded" onclick="return confirm('¿Eliminar?');">Borrar</button>
    </form>
  <?php endforeach; ?>
  <form method="post" class="grid grid-cols-7 gap-2 mb-4 items-center">
    ...
    <button name="addProduct" class="px-3 bg-green-600 text-white rounded col-span-2">Agregar</button>
  </form>
<?php endif; ?>
</div>
</body>
